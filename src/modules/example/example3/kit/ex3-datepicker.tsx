...
import {Ex3Calendar, type Ex3CalendarMarkedDate, type Ex3CalendarSize} from './ex3-calendar';

export type Ex3DatepickerProps = {
  value?: Date | null;
  ...
  return (
    <div
      ...
      className={joinClasses(
        'ex3k-datepicker',
        `ex3k-datepicker--${uiSize}`,
        open && 'ex3k-datepicker--open',
        disabled && 'ex3k-datepicker--disabled',
        readOnly && 'ex3k-datepicker--readonly',
        invalid && 'ex3k-datepicker--invalid',
        className,
      )}
    >
      <div className="ex3k-datepicker__control">
        <input
          id={inputId}
          name={name}
          type="text"
        ...
        <div className="ex3k-datepicker__actions">
          {clearable && selected && !disabled && !readOnly ? (
            <button
              type="button"
              className="ex3k-datepicker__clear"
              onClick={handleClear}
          ...
          <button
            type="button"
            className="ex3k-datepicker__trigger"
      ...
      {open ? (
        <div
          id={`${inputId}-calendar`}
          className="ex3k-datepicker__popover"
          role="dialog"
        ...
        >
          <Ex3Calendar
            ...
            uiSize={uiSize}
            locale={locale}
            className="ex3k-calendar--popover"
          />
        </div>
      ) : null}
    </div>
