...
import {KaisaDatepicker, KaisaField} from './kit';
      ...
      <Example3ShowcaseSection title="Basic" description="입력 · 캘린더 아이콘 · 날짜 선택">
        <div className="kaisa-state-grid kaisa-state-grid--pickers">
          <Example3StateCard label="Default">
            <KaisaField label="일정 날짜" htmlFor="kaisa-datepicker-default" hint="직접 입력 또는 캘린더">
              <KaisaDatepicker
                id="kaisa-datepicker-default"
                value={selectedDate}
          ...
          <Example3StateCard label="With marked dates">
            <KaisaField label="예약 가능일" htmlFor="kaisa-datepicker-marked">
              <KaisaDatepicker
                id="kaisa-datepicker-marked"
      ...
      <Example3ShowcaseSection title="Size" description="sm · md · lg">
        <div className="kaisa-state-grid kaisa-state-grid--pickers">
          <Example3StateCard label="Small">
            <KaisaDatepicker uiSize="sm" defaultValue={anchorDate} clearable />
          </Example3StateCard>
          <Example3StateCard label="Medium">
            <KaisaDatepicker uiSize="md" defaultValue={anchorDate} clearable />
          </Example3StateCard>
          <Example3StateCard label="Large">
            <KaisaDatepicker uiSize="lg" defaultValue={anchorDate} clearable />
          </Example3StateCard>
        </div>
      </Example3ShowcaseSection>
      ...
      <Example3ShowcaseSection title="Input mode" description="manual · calendar only · min/max">
        <div className="kaisa-state-grid kaisa-state-grid--pickers">
          <Example3StateCard label="Manual input">
            <KaisaField label="날짜 입력" hint="2026.06.27 형식">
              <KaisaDatepicker
                value={rangeDate}
          ...
          <Example3StateCard label="Min / Max">
            <KaisaField label="이번 달만" hint={`${minDate.getDate()}일 ~ ${maxDate.getDate()}일`}>
              <KaisaDatepicker minDate={minDate} maxDate={maxDate} defaultValue={anchorDate} />
            </KaisaField>
          </Example3StateCard>
        </div>
      </Example3ShowcaseSection>
      ...
      <Example3ShowcaseSection title="State" description="disabled · readOnly · invalid">
        <div className="kaisa-state-grid kaisa-state-grid--pickers">
          <Example3StateCard label="Disabled">
            <KaisaField label="마감일" disabled>
              <KaisaDatepicker disabled defaultValue={anchorDate} />
            </KaisaField>
          </Example3StateCard>
          <Example3StateCard label="Read only">
            <KaisaField label="확정일" hint="조회만 가능">
              <KaisaDatepicker
                readOnly
          ...
          <Example3StateCard label="Invalid">
            <KaisaField label="체크인" error="유효한 날짜를 입력해 주세요">
              <KaisaDatepicker invalid defaultValue={anchorDate} />
            </KaisaField>
          </Example3StateCard>
        </div>
      </Example3ShowcaseSection>
