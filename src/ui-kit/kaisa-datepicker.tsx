...
import {KaisaCalendar, type KaisaCalendarMarkedDate, type KaisaCalendarSize} from './kaisa-calendar';

export type KaisaDatepickerProps = {
  value?: Date | null;
...
export function KaisaDatepicker({
  value,
  defaultValue = null,
  onChange,
  placeholder,
  ...
  return (
    <div
      ...
      className={joinClasses(
        'kaisa-datepicker',
        `kaisa-datepicker--${uiSize}`,
        open && 'kaisa-datepicker--open',
        disabled && 'kaisa-datepicker--disabled',
        readOnly && 'kaisa-datepicker--readonly',
        invalid && 'kaisa-datepicker--invalid',
        className,
      )}
    >
      <div className="kaisa-datepicker__control">
        <input
          id={inputId}
          name={name}
          type="text"
        ...
        <div className="kaisa-datepicker__actions">
          {clearable && selected && !disabled && !readOnly ? (
            <button
              type="button"
              className="kaisa-datepicker__clear"
              onClick={handleClear}
          ...
          <button
            type="button"
            className="kaisa-datepicker__trigger"
      ...
      {open ? (
        <div
          id={`${inputId}-calendar`}
          className="kaisa-datepicker__popover"
          role="dialog"
        ...
        >
          <KaisaCalendar
            ...
            uiSize={uiSize}
            locale={locale}
            className="kaisa-calendar--popover"
          />
        </div>
      ) : null}
    </div>
